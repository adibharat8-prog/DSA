...
Then we start a for loop from i=1 to nums.size()-1 and make 3 variable v1= ith element, v2 = ith ele * maxEnd and v3=ith ele * minEnd now we every time we store store max and min value among three of them in maxEnd and minEnd respectively.<br>
